...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(MainScreen.records,"Num Records","Num Records");
	localDefaultCategoryDataset.addValue(MainScreen.time,"Anonymized Time","Anonymized Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Num Records Vs Execution Time", "Time (M.Sec)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
